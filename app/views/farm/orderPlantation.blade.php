...
<?php $title = '農園づくり | 農園新設工事を受託する企業【オーガニックパパ】' ?>
<?php $description = 'オーガニックパパは、お客様の様々なニーズに合わせて、農園新設工事の受託をさせていただいております。有機農業は「土づくり」から。九州野菜をメインとしたオーガニック野菜といえばオーガニックパパへ。'; ?>
<?php $keywords = 'オーガニック,農園づくり,農園新設,受託,土づくり'; ?>
