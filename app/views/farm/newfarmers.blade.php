...
<?php $title = '農園体験・見学 | 農業研修生'; ?>
<?php $description = 'グリーンハンドは、農業研修生を受け入れしております。新規就農をご検討の方はご連絡ください。九州野菜をメインとしたオーガニック野菜といえばオーガニックパパへ。'; ?>
<?php $keywords = 'オーガニック,農園体験,農園見学,農業県修正,グリーンハンド'; ?>
