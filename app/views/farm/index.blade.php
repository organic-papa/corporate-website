...
<?php $title = '農園づくり | オーガニックパパで取り扱う農園情報'; ?>
<?php $description = '九州野菜をメインとしたオーガニック野菜といえばオーガニックパパへ。オーガニックパパの農園づくり情報を掲載しています。無農薬・有機野菜など安心・安全でおいしい食材を作る農園情報。'; ?>
<?php $keywords = 'オーガニック,無農薬野菜,有機野菜,有機農業,農園情報'; ?>
